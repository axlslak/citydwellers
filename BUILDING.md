...
banker AO clients under one supervisor. Flipper runs in its own process so its
short-lived AOSharp client domain cannot share process-global runtime state with
Manager, Buddies, or Bankers. All components remain concurrent. Flipper does not log its
